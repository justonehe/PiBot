...
def create_skill(args):
    ...
    try:
        ...
        is_smart = "✨ Smart template" if matched_pattern else "📝 Standard template"
...
"""
        ...
        if matched_pattern:
            ...
            elif "cmd" in matched_pattern:
                result += "   - Shell command execution\n"
                result += "   - Security checks for dangerous commands\n"
                result += "   - Timeout protection (30s)\n"
